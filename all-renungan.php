...
<body id="page-top">
  ...
  <?php
    ...
    $sql = "SELECT *, date_format(berita.tanggal, '%d - %M -  %Y') as tgl FROM berita, kategori_info WHERE (berita.kategori_info = kategori_info.kode_info) AND (berita.kategori_info = '2') AND (berita.judul_berita LIKE :keyword OR berita.isi LIKE :keyword OR berita.penulis LIKE :keyword) ORDER BY berita.id_berita DESC";
