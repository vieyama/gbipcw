...
function antiinjection($data){
  ...
  $qy= mysqli_query($koneksi, "DELETE FROM user WHERE id_user='$id'");

	if ($qy)
	{

			echo '<script type="text/javascript">swal("Hapus Berhasil","Data user Terhapus !", "success").then(() => {window.location="daftar-user";});</script>';
		...
		echo '<script type="text/javascript">swal("Hapus Gagal","Silahkan Cek Lagi !", "error").then(() => {window.location="daftar-user";});</script>';
